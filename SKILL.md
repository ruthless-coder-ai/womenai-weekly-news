...
不选融资估值人事。**读者主体是国内小红书用户**：国内大厂/监管/可用的
开源模型优先；海外新闻影响力够大或波及国内用户才选，纯美国本地事不选；
提国内公司说国产或中文名，不写「中国公司 XX」。必须在本期日期范围内且有信源。

搜的时候中英文都搜、按角度分别搜（如「国产大模型 新闻 + 当周日期」、
"China AI news" + 当周日期），交叉核对报道日期确实落在范围内。
